...
from PyQt5.QtWidgets import QGraphicsRectItem, QApplication, QGraphicsView, QGraphicsScene, QGraphicsItem,QDialog,QWidget,QPushButton,QGraphicsPixmapItem,QGraphicsObject,QFileDialog
...
class GraphicsRectItem(QGraphicsRectItem):  # class QGraphicsRectItem for draw rectangle ingraphicsence
    ...
    def boundingRect(self):
        ...
        self.rect().adjusted(-o, -o, o, o) # adjusted() Returns a new rectangle with dx1, dy1, dx2 and dy2 added respectively to the existing coordinates of this rectangle
    ...
    def paint(self, painter, option, widget=None):
        ...
        painter.setPen(QPen(QColor(12, 183, 84), 2.0, Qt.SolidLine))
